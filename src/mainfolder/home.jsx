...
import { OrbitControls, PerspectiveCamera, useGLTF, useProgress, Html } from '@react-three/drei';
...
export function GetScene({ setScene }) {
...
const Home = () =>  {
    const [homeScene, setHScene] = useState(null);
        ...
        <React.Fragment>
            <div style={{height: '85vh', width: '100%'}}>
                <Canvas dpr={[1.5, 2]} linear shadows>
                    ...
                    {active===false ? <GetScene setScene={setHScene} /> : ''}
                </Canvas>

                {active===false && <ExportButton scene={homeScene} />}
            </div>
        </React.Fragment>
    );
};
